...
timeout. Transient failures such as HTTP `408`, `429`, `503`, `504`, and
request timeouts are reported separately and do not fail the action by default.
...
```yaml
      - uses: jupyterlab/maintainer-tools/.github/actions/check-links@v1
        with:
          request_timeout: "20"
          transient_status_codes: "408 429 503 504"
